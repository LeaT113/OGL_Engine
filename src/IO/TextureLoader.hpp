...
{
public:
    static Handle<Texture> LoadTexture2D(const std::string &name, const Texture::Params& params = {});
...
private:
    ...
    static void SetTextureParams(const Texture::Params& params, unsigned int target);
};
