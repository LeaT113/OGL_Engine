...
Handle<Mesh> MeshFactory::CreateQuad()
{
    ...
    auto vertexBuffer =  Handle<VertexBuffer>::Make(nullptr, (GetVertexAttributeInfo(VertexAttribute::Position).byteSize + GetVertexAttributeInfo(VertexAttribute::TexCoord0).byteSize) * 4);
    unsigned int offset = 0;
    vertexBuffer->InsertAttribute(VertexAttribute::Position, offset, positions, 4);
    vertexBuffer->InsertAttribute(VertexAttribute::TexCoord0, offset, uvs, 4);
